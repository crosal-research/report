...
- *Balance of risks have tilted*. The latest flow of news have
...
- *The Genie out of the box*. Simply put, once one makes a
  ...
  concessions may well fall shot of the mounting pressures arising
  either within politicians class or from specific sectors of the
  society.

- *Any counteracting pressure?* In light of the fore mentioned, the
...
- *A two-fold path*. As in \ref{fig:spreads}, Brazilian sovereign
...
- *A new Round of Reforms*. Be all that as it may, what is become
